...
SystemClock_Config_56_FORPUSH:
	...
	sub.w	lr, lr, #21
	cmp	lr, r2
	beq	SystemClock_Config_60_SAFE
	bx	lr
SystemClock_Config_60_SAFE:
	pop.w	{r0, r1, r2, lr}
...
SystemClock_Config_60_FORPUSH:
	...
	sub.w	lr, lr, #21
	cmp	lr, r2
	beq	SystemClock_Config_64_SAFE
	bx	lr
SystemClock_Config_64_SAFE:
	pop.w	{r0, r1, r2, lr}
...
MX_I2C1_Init_64_FORPUSH:
	...
	sub.w	lr, lr, #21
	cmp	lr, r2
	beq	MX_I2C1_Init_68_SAFE
	bx	lr
MX_I2C1_Init_68_SAFE:
	pop.w	{r0, r1, r2, lr}
...
MX_I2S3_Init_68_FORPUSH:
	...
	sub.w	lr, lr, #21
	cmp	lr, r2
	beq	MX_I2S3_Init_72_SAFE
	bx	lr
MX_I2S3_Init_72_SAFE:
	pop.w	{r0, r1, r2, lr}
...
MX_SPI1_Init_72_FORPUSH:
	...
	sub.w	lr, lr, #21
	cmp	lr, r2
	beq	MX_SPI1_Init_76_SAFE
	bx	lr
MX_SPI1_Init_76_SAFE:
	pop.w	{r0, r1, r2, lr}
...
MX_USART2_UART_Init_76_FORPUSH:
	...
	sub.w	lr, lr, #21
	cmp	lr, r2
	beq	MX_USART2_UART_Init_80_SAFE
	bx	lr
MX_USART2_UART_Init_80_SAFE:
	pop.w	{r0, r1, r2, lr}
